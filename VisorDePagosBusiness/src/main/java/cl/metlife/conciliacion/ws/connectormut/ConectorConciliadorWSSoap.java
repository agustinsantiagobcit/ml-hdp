...
public interface ConectorConciliadorWSSoap {
     ...
     * @return
     *     returns cl.metlife.conciliacion.ws.connector2.ResultadoConciliacion
     */
    @WebMethod(operationName = "ConciliarPago", action = "ConciliarPago")
    @WebResult(name = "Resultado", targetNamespace = "")
    @RequestWrapper(localName = "ConciliarPago", targetNamespace = "http://ws.conciliacion.hdp.metlife.cl/", className = "cl.metlife.conciliacion.ws.connector2.ConciliarPago")
    @ResponseWrapper(localName = "ConciliarPagoResponse", targetNamespace = "http://ws.conciliacion.hdp.metlife.cl/", className = "cl.metlife.conciliacion.ws.connector2.ConciliarPagoResponse")
