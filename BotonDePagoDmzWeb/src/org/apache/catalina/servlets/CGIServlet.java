...
public final class CGIServlet extends HttpServlet {
    ...
    private boolean absoluteCgiPathPrefix = false;
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        cgiPathPrefix = ps.getEnviromentConfig("PagoCGIPath", config.getServletContext());  //System.getProperty("PagoCGIPath");//getServletConfig().getInitParameter("cgiPathPrefix");
        ...
        if (getServletConfig().getInitParameter("absoluteCgiPathPrefix") != null) {
            absoluteCgiPathPrefix = Boolean.valueOf(getServletConfig().getInitParameter("absoluteCgiPathPrefix")).booleanValue();
        }
    ...
    protected class CGIEnvironment {
        ...
        protected String[] findCGI(String pathInfo, String webAppRootDir,
            ...
            if (cgiPathPrefix != null) {
                if(absoluteCgiPathPrefix == false) {
                    webAppRootDir = webAppRootDir + File.separator
                            + cgiPathPrefix;
                }
                else {
                    webAppRootDir = cgiPathPrefix;
                }
            }
    ...
    protected class CGIRunner {
        ...
        protected CGIRunner(String command, Hashtable<String,String> env,
            ...
            this.command = command;//"C:\\cgi\\santander\\hipo\\cgicomer.exe";//
            this.env = env;
            this.wd = wd;
            this.params = params;
            updateReadyStatus();
