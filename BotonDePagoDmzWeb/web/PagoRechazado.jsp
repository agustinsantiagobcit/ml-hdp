        ...
        <div id="content" class="clearfix container">
            ...
            <div class="box">
                <div class="int-box box-shadow--6dp">
                    ...
                    <p>
                                Estimado Cliente la orden de compra <c:if test="${not empty ordenPago}" >Nº ${ordenPago}</c:if> no pudo ser pagada.
                    </p>

                    <c:if test="${not empty razonRechazo}">
                        <p>
                            Motivo de rechazo: ${razonRechazo}
                        </p>
                    </c:if>
